...
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.case_tag > falsy when before and truthy when after else] - jinja2.exceptions.TemplateSyntaxError: Encountered unknown tag 'when'. Jinja was looking for the following tags: 'endcase'. The innermost block that needs to be closed is 'case'.
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.case_tag > falsy when before and truthy when after multiple else blocks] - jinja2.exceptions.TemplateSyntaxError: Encountered unknown tag 'else'. Jinja was looking for the following tags: 'endcase'. The innermost block that needs to be closed is 'case'.
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.case_tag > mix or and comma separated when expression] - AssertionError: assert '' == 'barbar'
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.case_tag > multiple else blocks] - jinja2.exceptions.TemplateSyntaxError: Encountered unknown tag 'else'. Jinja was looking for the following tags: 'endcase'. The innermost block that needs to be closed is 'case'.
...
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.case_tag > truthy when before and after else] - jinja2.exceptions.TemplateSyntaxError: Encountered unknown tag 'when'. Jinja was looking for the following tags: 'endcase'. The innermost block that needs to be closed is 'case'.
...
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.if_tag > else tag expressions are ignored] - jinja2.exceptions.TemplateSyntaxError: expected token 'end of statement block', got 'nonsense'
...
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.if_tag > extra else blocks are ignored] - jinja2.exceptions.TemplateSyntaxError: Encountered unknown tag 'else'. Jinja was looking for the following tags: 'endif'. The innermost block that needs to be closed is 'if'.
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.if_tag > extra elsif blocks are ignored] - jinja2.exceptions.TemplateSyntaxError: Encountered unknown tag 'elsif'. Jinja was looking for the following tags: 'endif'. The innermost block that needs to be closed is 'if'.
...
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.inline_comment_tag > comment with double quote] - jinja2.exceptions.TemplateSyntaxError: unexpected char '#' at 2
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.inline_comment_tag > comment with double quoted string] - jinja2.exceptions.TemplateSyntaxError: unexpected char '#' at 2
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.inline_comment_tag > comment with single quote] - jinja2.exceptions.TemplateSyntaxError: unexpected char '#' at 2
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.inline_comment_tag > comment with single quoted string] - jinja2.exceptions.TemplateSyntaxError: unexpected char '#' at 2
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.inline_comment_tag > comment with u2018] - jinja2.exceptions.TemplateSyntaxError: unexpected char '#' at 2
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.inline_comment_tag > comment with u201C] - jinja2.exceptions.TemplateSyntaxError: unexpected char '#' at 2
...
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.liquid_tag > bare liquid tag in liquid tag] - jinja2.exceptions.TemplateSyntaxError: Encountered unknown tag 'liquid'.
...
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.map_filter > input is a hash] - AssertionError: assert '<built-in me...7fe6f0749830>' == 'foo'
...
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.output_statement > top-level quoted, bracketed variable name with whitespace] - assert "['bar baz']" == '42'
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.output_statement > top-level quoted, bracketed variable name with whitespace followed by dot notation] - AssertionError: assert '' == '42'
...
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.split_filter > empty string and single char argument] - AssertionError: assert '0' == ''
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.split_filter > left matches argument] - AssertionError: assert '01' == ''
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.split_filter > left matches string repr of argument] - TypeError: must be str or None, not int
...
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.sum_filter > hashes with numeric strings and property argument] - TypeError: unsupported operand type(s) for +: 'int' and 'str'
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.sum_filter > hashes with some missing properties] - jinja2.exceptions.UndefinedError: 'dict object' has no attribute 'k'
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.sum_filter > hashes without property argument] - TypeError: unsupported operand type(s) for +: 'int' and 'dict'
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.sum_filter > negative strings] - TypeError: unsupported operand type(s) for +: 'int' and 'str'
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.sum_filter > nested ints] - TypeError: unsupported operand type(s) for +: 'int' and 'list'
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.tablerow_tag > break from a tablerow loop] - assert '<tr class="r..."col1">3</tr>' == '<tr class="r...1</td></tr>\n'
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.tablerow_tag > break from a tablerow loop inside a for loop] - assert '\\n\\n<tr cl...after loop\\n' == '\\n\\n<tr cl...after loop\\n'
...
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.tablerow_tag > continue from a tablerow loop] - assert '<tr class="r..."col1">3</tr>' == '<tr class="r...3</td></tr>\n'
...
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.unless_tag > else tag expressions are ignored] - jinja2.exceptions.TemplateSyntaxError: expected token 'end of statement block', got 'nonsense'
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.unless_tag > extra else blocks are ignored] - jinja2.exceptions.TemplateSyntaxError: Encountered unknown tag 'else'. Jinja was looking for the following tags: 'endunless'. The innermost block that needs to be closed is 'unless'.
FAILED test_golden_liquid.py::test_render_liquid[liquid.golden.unless_tag > extra elsif blocks are ignored] - jinja2.exceptions.TemplateSyntaxError: Encountered unknown tag 'elsif'. Jinja was looking for the following tags: 'endunless'. The innermost block that needs to be closed is 'unless'.
...
467 failed, 421 passed in 8.89s
```
